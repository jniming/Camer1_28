...
import com.example.ipcam.camer.P2pAudioActivity;
...
public class IpcaudioListAdpter extends BaseAdapter {

    private List<IpcDevice> list;
    private Context context;
    private int temp = 0;    // 1代表消息,2代表录像

    public IpcaudioListAdpter(Context context, List<IpcDevice> list, int temp) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view.isonline = (TextView) convertView
                    .findViewById(R.id.audio_item_isonline);
        ...
        view.isonline.setText(Util.state(map.getConnect_state()));
        ...
        convertView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                    Intent intent = new Intent(context, P2pAudioActivity.class);
